...
Текущий public best команды: `0.16461` на ветке решений
`hybrid_yolo26l_best_agn038_seq_tcn_snap4_rootcount088`. Проверено через
Kaggle CLI 2026-05-21T13:09Z: видимый лидер теперь `кто убил бенчмарка` с
`0.29887`, команда `Los Pollos Hermanos` имеет `0.16461`, следующий видимый
score `0.10431`; использовано `8/30` сабмитов за UTC-день, но рабочий
пользовательский лимит остается строже: максимум 2 новых сабмита только под
явный прорыв.
