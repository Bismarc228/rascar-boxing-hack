...
| automatic row-source policy with RGB/audio/tracklet sources | Oracle headroom is high (`0.429550`), but current policies stay below the best single source (`hgb=0.403028` vs `0.405200`); no test CSV generated. |
